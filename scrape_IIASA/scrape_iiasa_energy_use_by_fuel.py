...
for region in regions:
    ...
    while clicked_activity_dropdown==False:
        try:
            ...
            activity_dropdown.select_by_visible_text("Energy use")
    ...
    while clicked_key_fuels_button==False:
        try:
            key_fuels=driver.find_element_by_xpath('/html/body/div[3]/div[3]/a[5]')
            key_fuels.click()
    ...
    out_dir='C:/Users/lorenzo/Documents/IIASA_emmission_factors/energy_use/'
    error_file=out_dir+'errors_energy_use.txt'

    done_all=glob.glob('C:/Users/lorenzo/Documents/IIASA_emmission_factors/energy_use/*.csv')    
    ...
    for country in missing_countries:
        ...
        while str(country).find('Select')==-1 and os.path.isfile(destination)==False:
            ...
            download='C:/Users/lorenzo/Downloads/aen_keyfuel.csv'   
            download_wait=0
